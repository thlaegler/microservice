...
/**
 * This is the item provider adapter for a {@link microserviceModel.Architecture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createArtifact()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createSpring()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createGateway()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createGrpcJar()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createJar()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceModelPackage.Literals.ARCHITECTURE__ARTIFACTS,
				 MicroserviceModelFactory.eINSTANCE.createOption()));
	}
