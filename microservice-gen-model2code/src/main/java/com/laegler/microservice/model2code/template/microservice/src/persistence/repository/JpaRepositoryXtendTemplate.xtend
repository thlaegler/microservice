package com.laegler.microservice.model2code.template.microservice.src.persistence.repository
 ...
 */
class JpaRepositoryXtendTemplate extends AbstractXtendTemplate {
