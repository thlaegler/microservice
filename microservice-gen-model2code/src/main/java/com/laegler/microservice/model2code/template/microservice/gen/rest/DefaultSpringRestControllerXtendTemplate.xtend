//package com.laegler.microservice.model2code.template.microservice.gen.rest
//
...
// */
//class DefaultSpringRestControllerXtendTemplate extends AbstractXtendTemplate {
//
