package com.laegler.microservice.model2code.template.microservice.gen.grpc.server
 ...
 */
class DefaultGrpcServerHandlerXtendTemplate extends AbstractXtendTemplate {
