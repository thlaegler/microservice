...
@Named
class WebsocketPomXml extends PomXml {

	protected static final Logger LOG = LoggerFactory.getLogger(WebsocketPomXml)

	public def Template getTemplate(Project p, SubProjectType sub) {
