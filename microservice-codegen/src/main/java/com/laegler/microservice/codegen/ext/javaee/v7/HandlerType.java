...
public class HandlerType {
    ...
    protected com.laegler.microservice.codegen.ext.javaee.v7.String handlerName;
    ...
    protected List<com.laegler.microservice.codegen.ext.javaee.v7.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.laegler.microservice.codegen.ext.javaee.v7.String> portName;
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.javaee.v7.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.laegler.microservice.codegen.ext.javaee.v7.String value) {
     ...
     * 
     */
    public List<com.laegler.microservice.codegen.ext.javaee.v7.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.laegler.microservice.codegen.ext.javaee.v7.String>();
        }
     ...
     * 
     */
    public List<com.laegler.microservice.codegen.ext.javaee.v7.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.laegler.microservice.codegen.ext.javaee.v7.String>();
        }
