...
package com.laegler.microservice.codegen.ext.webapp.v3_1;
...
public class MailSessionType {
    ...
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String storeProtocol;
    ...
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String host;
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String user;
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String password;
    protected com.laegler.microservice.codegen.ext.webapp.v3_1.String from;
     ...
     * @return
     *     possible object is
     *     {@link com.laegler.microservice.codegen.ext.webapp.v3_1.String }
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getUser() {
        return user;
    }
     ...
     *     
     */
    public void setUser(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
        this.user = value;
    }
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getPassword() {
        return password;
    }
     ...
     *     
     */
    public void setPassword(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
        this.password = value;
    }
     ...
     *     
     */
    public com.laegler.microservice.codegen.ext.webapp.v3_1.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(com.laegler.microservice.codegen.ext.webapp.v3_1.String value) {
        this.from = value;
    }
